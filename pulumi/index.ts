...
export = async () => {
    ...
    const app_db_sg_name = config.require("app-db-sg-name")
    ...
    const alb_security_group_web = new aws.ec2.SecurityGroup("alb-security-group-web", {
    ...
    const asg_security_group_web = new aws.ec2.SecurityGroup("asg-security-group-web", {
    ...
    const alb_security_group_app = new aws.ec2.SecurityGroup("alb-security-group-app", {
    ...
    const asg_security_group_app = new aws.ec2.SecurityGroup("asg-security-group-app", {
    ...
    const pri_rt_association_1 = new aws.ec2.RouteTableAssociation("pri-rt-association-1", {
        subnetId: app_subnet1.id,
        routeTableId: private_route_table.id,
    })

    const pri_rt_association_2 = new aws.ec2.RouteTableAssociation("pri-rt-association-2", {
    ...
    const pub_rt_association_1 = new aws.ec2.RouteTableAssociation("pub-rt-association-1", {
        subnetId: web_subnet1.id,
        routeTableId: public_route_table.id,
    })

    const pub_rt_association_2 = new aws.ec2.RouteTableAssociation("pub-rt-association-2", {
    ...
    return {
        "web-server-dns": alb_web.dnsName,
    }
}
